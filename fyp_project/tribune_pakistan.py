...
pagelink =requests.get('https://tribune.com.pk/pakistan/')
...
for count in range(0,len(allnews)):
    tribune_pakistan_list[count]=[list3[count],list2[count],list1[count],list4[count]]
print(tribune_pakistan_list)