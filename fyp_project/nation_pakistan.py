...
pagelink =requests.get('https://nation.com.pk/national')
...
for count in range(0,len(newstit)):
    nation_pakistan_list[count]=[list2[count],list3[count],list1[count],list4[count]]
print(nation_pakistan_list)