...
pagelink =requests.get('https://en.dailypakistan.com.pk/sports')
...
for all_data in allnews:
    ...
    dailyPak_sports_list[count]=[news_title,image_url,link,"Daily Pakistan"]
    count+=1
print(dailyPak_sports_list)