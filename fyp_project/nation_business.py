...
pagelink =requests.get('https://nation.com.pk/business')
...
for count in range(0,len(newstit)):
    nation_business_list[count]=[list2[count],list3[count],list1[count],list4[count]]
print(nation_business_list)